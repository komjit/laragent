        ...
        if ($currency == null || $currency == '' || $currency === "Ft" || $currency == "HUF") {
            ...
            switch ($currency) {
                ...
                case self::CURRENCY_AUD:
                    ...
                    break;
                case self::CURRENCY_AED:
                    $result = "Arab Emírségek dirham";
                    break;
                case self::CURRENCY_BRL:
                    $result = "brazil real";
                    break;
                ...
                case self::CURRENCY_CHF:
                    $result = "svájci frank";
                    break;
                case self::CURRENCY_CNY:
                    $result = "kínai jüan";
                    break;
                case self::CURRENCY_CZK:
                    $result = "cseh korona";
                    break;
                case self::CURRENCY_DKK:
                    $result = "dán korona";
                    break;
                case self::CURRENCY_EEK:
                    $result = "észt korona";
                    break;
                case self::CURRENCY_GBP:
                    $result = "angol font";
                    break;
                case self::CURRENCY_HKD:
                    $result = "hongkongi dollár";
                    break;
                case self::CURRENCY_HRK:
                    $result = "horvát kúna";
                    break;
                case self::CURRENCY_ISK:
                    $result = "izlandi korona";
                    break;
                case self::CURRENCY_JPY:
                    $result = "japán jen";
                    break;
                case self::CURRENCY_LTL:
                    $result = "litván litas";
                    break;
                case self::CURRENCY_LVL:
                    $result = "lett lat";
                    break;
                case self::CURRENCY_MXN:
                    $result = "mexikói peso";
                    break;
                case self::CURRENCY_NOK:
                    $result = "norvég koron";
                    break;
                case self::CURRENCY_NZD:
                    $result = "új-zélandi dollár";
                    break;
                case self::CURRENCY_PLN:
                    $result = "lengyel zloty";
                    break;
                case self::CURRENCY_RON:
                    $result = "új román lej";
                    break;
                case self::CURRENCY_RUB:
                    $result = "orosz rubel";
                    break;
                case self::CURRENCY_SEK:
                    $result = "svéd koron";
                    break;
                case self::CURRENCY_UAH:
                    $result = "ukrán hryvna";
                    break;
                case self::CURRENCY_BGN:
                    $result = "bolgár leva";
                    break;
                case self::CURRENCY_RSD:
                    $result = "szerb dínár";
                    break;
                case self::CURRENCY_ILS:
                    $result = "izraeli sékel";
                    break;
                case self::CURRENCY_IDR:
                ...
                case self::CURRENCY_VND:
                    ...
                    break;
                case self::CURRENCY_SGD:
                    $result = "szingapúri dollár";
                    break;
                case self::CURRENCY_THB:
                    $result = "thai bát";
                    break;
                case self::CURRENCY_KRW:
                    $result = "dél-koreai won";
                    break;
                case self::CURRENCY_MYR:
                    $result = "maláj ringgit";
                    break;
                case self::CURRENCY_PHP:
                    $result = "fülöp-szigeteki peso";
                    break;
                case self::CURRENCY_ZAR:
